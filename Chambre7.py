...
# Ajouter de titre
lbltitre=Label(fenetre, borderwidth=0, relief=SUNKEN, text="GESTION ACHAT"
...
idAchat=Label(fenetre, text="ID ACHAT:", font=("Arial", 14), bg="white", fg="BLACK")
idAchat.place(x=210, y=200)
textidAchat=Entry(fenetre, bd=4, font=("Arial", 13))
textidAchat.place(x=450, y=200,  width=300, height=35)


idAdherent=Label(fenetre,text="ID ADHERENT:", font=("Arial", 14), bg="white", fg="BLACK")
idAdherent.place(x=210, y=250)
textidAdherent=Entry(fenetre, bd=4, font=("Arial", 13))
textidAdherent.place(x=450, y=250,  width=300, height=35)

idLivre=Label(fenetre, text="ID LIVRE:", font=("Arial",14), bg="white", fg="BLACK")
idLivre.place(x=210, y=300)
textidLivre=Entry(fenetre, bd=4, font=("Arial", 14))
textidLivre.place(x=450, y=300, width=300, height=35)

dateAchat=Label(fenetre, text="DATE  D'ACHAT:", font=("Arial",14), bg="white", fg="BLACK")
dateAchat.place(x=210, y=350)
textDatedAchat=Entry(fenetre, bd=4, font=("Arial", 14))
textDatedAchat.place(x=450, y=350, width=300, height=35)
...
retour=customtkinter.CTkButton(fenetre, text="RETOUR",text_font=("#000000", 15), text_color="black",bg="light gray",
                                fg_color="light gray", hover=True,hover_color="white", border_width=1, corner_radius=1 )
